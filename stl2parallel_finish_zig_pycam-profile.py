...
ngc_writer.clearance_height= 4 # writer lifts cutter to this height for rapid-traverse
ngc_writer.feed_height = 0.3  # below this height the plunge-feed is used
ngc_writer.feed = 200
ngc_writer.plunge_feed = 100
ngc_writer.metric = True
...
if __name__ == "__main__": 
    ...
    xmin=0
    xmax=130
    zmin=-20 # cutter will be at this height, if we do not hit the model
